 ...
 * @subpackage Product_target/public
 */
...
class Product_target_Public {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/product_target-public.js', array( 'jquery' ), $this->version, false );
